...
MyDialogDevolucion::MyDialogDevolucion( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer58->Add( m_staticPrestar_NombreAlumno, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer58->Add( m_staticPrestar_NombreAlumno_Valor, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer57->Add( m_staticPrestar_DniAlumno, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer57->Add( m_staticPrestar_DniAlumno_Valor, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_btnConfirmarDevolucion = new wxButton( this, wxID_ANY, _("Devolver"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer18->Add( m_btnConfirmarDevolucion, 0, wxALIGN_RIGHT, 5 );


	bSizer59->Add( bSizer18, 1, wxALL|wxEXPAND, 5 );


	bSizerPrestarAAlumno->Add( bSizer59, 1, wxEXPAND, 5 );
	...
	bSizer70->Add( m_staticText23, 0, wxALL|wxEXPAND, 5 );


	bSizer64->Add( bSizer70, 0, wxALL|wxEXPAND, 5 );
	...
	bSizer46->Add( bSizer64, 1, wxALL|wxEXPAND, 5 );
