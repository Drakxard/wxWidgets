...
///////////////////////////////////////////////////////////////////////////////
/// Class MyDialogLectores
///////////////////////////////////////////////////////////////////////////////
class MyDialogLectores : public wxDialog
{
	private:
	...
	public:
		...
		MyDialogLectores( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Lectores del Libro"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 662,428 ), long style = wxDEFAULT_DIALOG_STYLE );
...
///////////////////////////////////////////////////////////////////////////////
/// Class MyDialogImportarExcel
///////////////////////////////////////////////////////////////////////////////
class MyDialogImportarExcel : public wxDialog
{
	private:
	...
	public:
		...
		MyDialogImportarExcel( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Importar desde Excel"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 554,376 ), long style = wxDEFAULT_DIALOG_STYLE );

		~MyDialogImportarExcel();
