...
struct Registro{
	...
	int tipo; //1 de prestamo; 2 de devolucion
...
public:
	...
	void Cargar_Historial(size_t idLibro, size_t idAlumno, string nom_usu, string nom_lib, int dia_dev, int mes_dev, int anio_dev, int dia_pres = 0, int mes_pres = 0, int anio_pres = 0, int tipoEvento = 1, string nombreArchivo="Recursos/Binarios/Historial.bin" );
