...
MyDialogLectores::MyDialogLectores( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticPrestar_DniAlumno = new wxStaticText( this, wxID_ANY, wxT("ID: "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticPrestar_DniAlumno->Wrap( -1 );
	bSizer57->Add( m_staticPrestar_DniAlumno, 0, wxALL, 5 );

	m_staticPrestar_DniAlumno_Valor = new wxStaticText( this, wxID_ANY, wxT("IdDeEjemplo"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticPrestar_DniAlumno_Valor->Wrap( -1 );
	bSizer57->Add( m_staticPrestar_DniAlumno_Valor, 0, wxALL, 5 );
	...
	m_staticText23 = new wxStaticText( this, wxID_ANY, wxT("Lectores Recientes"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText23->Wrap( -1 );
	bSizer70->Add( m_staticText23, 0, wxALL, 5 );
...
MyDialogLectores::~MyDialogLectores()
{
}

MyDialogImportarExcel::MyDialogImportarExcel( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticPrestar_NombreAlumno = new wxStaticText( this, wxID_ANY, wxT("Selecciona tu archivo : )"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticPrestar_NombreAlumno->Wrap( -1 );
	bSizer59->Add( m_staticPrestar_NombreAlumno, 0, wxALL, 5 );


	bSizerPrestarAAlumno->Add( bSizer59, 0, 0, 5 );


	bSizer46->Add( bSizerPrestarAAlumno, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_staticText23 = new wxStaticText( this, wxID_ANY, wxT("Previsualizacion"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText23->Wrap( -1 );
	bSizer70->Add( m_staticText23, 0, wxALL, 5 );
...
MyDialogImportarExcel::~MyDialogImportarExcel()
{
}
